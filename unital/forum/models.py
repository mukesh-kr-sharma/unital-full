...
class Question(models.Model):
    ...
    for_department = models.ForeignKey("main_app.Department", verbose_name=_("Question For Department"), on_delete=models.CASCADE)
    for_college = models.ForeignKey("main_app.College", verbose_name=_("Question For College"), on_delete=models.CASCADE)
